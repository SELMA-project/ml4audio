...
# for debugging
docker run -it -v ${PWD}:/code -v $CODE_DIR/misc-utils:/code/misc-utils -v $CODE_DIR/ml4audio:/code/ml4audio -v $CODE_DIR/misc-utils:/code/misc-utils -p 8000:8000 --rm $IMAGE bash
