...
def nemo_offline_vad_infer_main_original(
    audio_file, data_dir, config_yaml="speaker_tasks/tests/vad_test_config.yaml"
):
    cfg = OmegaConf.load(config_yaml)
    create_manifest(data_dir, audio_file)
    cfg.dataset = f"{data_dir}/vad_manifest.json"
    if not cfg.dataset:
